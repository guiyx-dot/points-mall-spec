...
export const SCENES: PrdScene[] = [
  ...
  },
  {
    ...
    screen: { name: 'mall' },
    notes: [
      '积分商城这一页只放自有货架。权益专区仍在本页兑换专用券。',
      '积分专区商品是福多多的 H5，没法嵌在同一页里，所以只放入口。点进入后二次跳转到福多多页面。',
      '顶部展示 90 天有效和最近到期日。',
    ],
  },
  {
    ...
    notes: [
      ...
      '用户承担的费率从到账金额里扣。兑成后点「去使用」进通用金页。之后可再从商城点进积分专区去花。',
    ],
  },
  {
    id: 'success-gold',
  ...
  },
  {
    ...
    title: '福多多 · 积分专区',
    kind: 'consumer',
    screen: { name: 'points-zone' },
    notes: [
      '从商城点「积分专区」后跳进这一页。实现上是嵌入福多多 H5，不是我方商品列表。',
      '支付一次只用一种：通用积分，或通用金，或一张券。不够就不能兑。',
      '商品、库存、发货都在福多多。扣积分要等对方下单成功后再扣。',
    ],
  },
  {
    id: 'detail-points',
    ...
    notes: [
      '积分专区下单发生在福多多页内：校验余额足够 → 福多多接单成功 → 再扣通用积分（或金/券）。失败要回滚。',
